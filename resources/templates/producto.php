...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb pan">
        <li class="breadcrumb-item"><a href="http://localhost/IOIMR">Inventario</a></li>
        <li class="breadcrumb-item"><a href="http://localhost/IOIMR/product/list">Productos</a></li>
        <li class="breadcrumb-item"><a href="http://localhost/IOIMR/product/create">Detalles</a></li>
    ...
    <main id="productos" class="  m-3">
        ...
        <div class="d-block d-lg-flex justify-content-between">
            ...
            <div class="form-group">
                <a href="http://localhost/IOIMR-prueba/product/createForm">
                    <button class="accordion" type="submit">Crear producto</button>
                </a>
            </div>

            <div class="row ">
                <label for="inputEmail3" class="col-sm-3 col-form-label">
                    <button class="accordion2" type="submit">Buscar</button>
                </label>
                <div class="col-sm-9">
                    <div class="col">
                        <input type="text" class="form-control" placeholder="Otros Filtros">
                    </div>
                </div>
            </div>
