...
class Conn {
    ...
    function __construct()
    {
        try {
            ...
            ob_clean();
            echo json_encode(["code"=>0,"message"=>"Error interno, si persiste comuniquese con el adminsitrador :: ".$e->getMessage()]);
            exit();
    ...
    public function prepararSentencia($sqlquery, $filtros)
    {
        ...
        try {
            ...
            echo json_encode(["code"=>0,"message"=>"Error interno, verifique los datos o comuniquese con el administrador :: ".$e->getMessage()]);
            exit();
        }
    }
